...
// @TODO Only let authenticated users to delete their own object
// @TODO Delete (cleanup) any other data files associated with this user
      ...
      if (!err && data) {
        _data.delete("users", phone, err => {
          if (!err) {
            ...
            callback(500, { Error: "Could not specified user" });
          }
        });
      } else {
